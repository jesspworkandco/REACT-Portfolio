    ...
    <Col xs={12} className="column">
      <Jumbotron fluid className="jumbo mx-sm-auto px-3 text-center">
        ...
        <p className="bio mt-4">
          ...
          with my education from Columbia University’s Full Stack web
          development Bootcamp My skillset and experience, puts me at the
          ...
          portfolio will show personal and team projects. A functionally written
          code will create an uninterrupted transition from one idea to the
          next. Professionally and personally, I’ve set sail my own segue from
          Marketing, and from France to the USA, with goals to accomplish this
